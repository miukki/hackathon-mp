...
}(this, function ()
{
	...
	}([function (e, t, n)
	{
		...
		(function ()
		{
			...
			{
				var r;
				if (void 0 !== (r = x(e) ? O.findIndex(e, t, n) : O.findKey(e, t, n)) && -1 !== r) return e[r]
			}, O.filter = O.select = function (e, t, n)
			{
				var r = [];
				return t = A(t, n), O.each(e, function (e, n, i)
				{
					t(e, n, i) && r.push(e)
				}), r
			}, O.reject = function (e, t, n)
			{
				return O.filter(e, O.negate(A(t)), n)
			}, O.every = O.all = function (e, t, n)
			{
				t = A(t, n);
				for (var r = !x(e) && O.keys(e), i = (r || e).length, o = 0; o < i; o++)
				{
					var s = r ? r[o] : o;
			...
			}, O.max = function (e, t, n)
			{
				...
				else t = A(t, n), O.each(e, function (e, n, r)
				{
			...
			{
				for (var t, n = x(e) ? e : O.values(e), r = n.length, i = Array(r), o = 0; o < r; o++) t = O.random(0, o), t !== o && (i[o] = i[t]), i[t] = n[o];
				return i
			...
			{
				return t = A(t, n), O.pluck(O.map(e, function (e, n, r)
				{
					return {
						value: e,
						index: n,
			...
			var k = function (e)
			{
				...
				{
					var i = {};
					return n = A(n, r), O.each(t, function (r, o)
					{
						var s = n(r, o, t);
						e(i, r, s)
					}), i
			...
			{
				O.isBoolean(t) || (r = n, n = t, t = !1), null != n && (n = A(n, r));
			...
			{
				return O.isObject(e) ? O.isArray(e) ? e.slice() : O.extend(
				{}, e) : e
			}, O.tap = function (e, t)
			{
				return t(e), e
          ...
          "\u2029": "u2029"
			...
			{
				!t && n && (t = n), t = O.defaults(
				{}, t, O.templateSettings);
			...
			O.mixin = function (e)
			{
				O.each(O.functions(e), function (t)
				{
					...
					{
						var e = [this._wrapped];
						return d.apply(e, arguments), V(this, n.apply(O, e))
					}
				})
	...
	}, function (e, t, n)
	{
		...
		var r = n(62),
			...
			v = function (e)
			{
				...
				return p(l, d).then(function (e)
				{
					...
					}).catch(function (e)
					{
						...
						{}
						throw t.error += " [" + (e.statusCode || "N/A") + " " + r + " " + v + "]", new a(t.code, t.error)
					})
				})
			},
			y = function (e, t, n, r)
			{
				...
				return r && "get" === r.toLowerCase() && (a = o(
				{}, a, i), i = null), v(
				{
					method: r,
					path: u,
		...
		var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e)
			...
			l = function (e)
			{
				var t = e.method,
					...
					f = e.onprogress,
					d = c++;
				a("request(" + d + ")", t, n, r, o, h);
				var p = {};
				if (r)
					for (var _ in r) "object" === i(r[_]) ? p[_] = JSON.stringify(r[_]) : p[_] = r[_];
				return new u(function (e, r)
				{
					var i = s(t, n).set(h).query(p).send(o);
					f && i.on("progress", f), i.end(function (t, n)
					{
						return n && a("response(" + d + ")", n.status, n.body || n.text, n.header), t ? (n && (t.statusCode = n.status, t.responseText = n.text, t.response = n.body), r(t)) : e(n.body)
					})
				})
			},
			h = function (e)
			...
			y = function (e, t, n)
			{
				...
				}, o.extend(r, e), v.prototype = e.prototype, r.prototype = new v, t && o.extend(r.prototype, t), n && o.extend(r, n), r.prototype.constructor = r, r.__super__ = e.prototype, r
			};
		e.exports = {
			ajax: l,
			isNullOrUndefined: h,
	...
	}, function (e, t, n)
	{
		...
		function s(e)
		{
			"" !== e.message && p && (p._readyState = f, p.dispatchEvent(
			{
				type: "error",
				message: e.errMsg
			}))
		...
		var a = function ()
			...
			_ = function (e)
			{
				function t(e, n)
				{
					...
					return o._url = e, o._protocal = "", o._readyState = l, p && p.dispatchEvent(
					{
						type: "close"
		...
		e.exports = function (e)
		{
			...
			e.Events = {
				on: function (e, n, r)
				{
					var i, o, s, a, u;
					if (!n) return this;
					for (e = e.split(t), i = this._callbacks || (this._callbacks = {}), o = e.shift(); o;) u = i[o], s = u ? u.tail :
					{}, s.next = a = {}, s.context = r, s.callback = n, i[o] = {
						tail: a,
						next: u ? u.next : s
					}, o = e.shift();
					return this
		...
		e.exports = function (e)
		{
			...
			}, r.extend(e.File.prototype,
			{
				...
				_finishFetch: function (t)
				{
					...
					{}, n.id = n.objectId, delete n.objectId, delete n.metaData, delete n.url, delete n.name, delete n.mime_type, delete n.bucket, r.extend(this, n), this
				}
			})
		}
	}, function (e, t, n)
	...
	}, function (e, t, n)
	{
		...
		i.init = function (e)
		{
			...
			s && console.warn("MasterKey is not supposed to be used in browser."), i._config.applicationId = t, i._config.applicationKey = n, i._config.masterKey = s, void 0 !== p && (i._config.production = p), void 0 !== d && (i._config.disableCurrentUser = d), i._appRouter = new o(i);
			var v = f || void 0 !== h || "cn" !== u;
			i._setServerURLs(c(
			{}, r(t, u), i._config.serverURLs, h), v), _ ? i._config.realtime = _ : i._sharedConfig.liveQueryRealtime && (i._config.realtime = new i._sharedConfig.liveQueryRealtime(
			{
				appId: t,
				region: u
			}))
			...
			},
			{
				init: function (t)
				{
					var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] :
						{},
						r = n.subscriptionId,
						i = void 0 === r ? e._getSubscriptionId() : r;
					...
					var s = t.toJSON(),
						...
						u = s.keys,
						l = s.returnACL;
					return o.resolve(i).then(function (n)
					{
						return c(
						{
							method: "POST",
	...
	}, function (e, t, n)
	{
		...
		var i = n(0),
			...
			d = function (e)
			{
				if (-1 !== f.indexOf(e)) throw new Error("key[" + e + "] is reserved")
			};
		e.exports = function (e)
		{
			e.Object = function (t, n)
			{
				...
				o && (t = i.extend(
				{}, o, t)), n && n.collection && (this.collection = n.collection), this._serverData = {}, this._opSetQueue = [
				{}], this._flags = {}, this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = i.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, this.set(t,
				{
					silent: !0
			...
			}, i.extend(e.Object.prototype, e.Events,
			{
				...
				set: function (t, n, r)
				{
					...
					if (i.isObject(t) || c(t) ? (o = i.mapObject(t, function (t, n)
						...
						}), r = n) : (o = {}, d(t), o[t] = e._decode(n, t)), r = r ||
						{}, !o) return this;
				...
				{
					var n = this;
					return a("classes", this.className, this.id, "GET", h(e), t).then(function (e)
					{
				...
				{
					var o, s, u;
					i.isObject(t) || c(t) ? (o = t, u = n) : (o = {}, o[t] = n, u = r), u = i.clone(u) ||
					{}, u.wait && (s = i.clone(this.attributes));
					var l = i.clone(u) ||
					{};
					...
					}) : (this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || e.Promise.resolve(), this._allPreviousSaves = this._allPreviousSaves.catch(function (e) {}).then(function ()
					{
						...
						{
							var t = h.parse(e);
							return u.wait && (t = i.extend(o ||
							{}, t)), h._finishSave(t), u.wait && h.set(s, l), h
						}, function (e)
						{
				...
				{
					!t.silent && this.validate && (e = i.extend(
			...
			}, e.Object.extend = function (t, n, r)
			{
				...
				{}, n._className = t, o = this._extend(n, r);
				...
				}, Object.defineProperty(o, "query", Object.getOwnPropertyDescriptor(e.Object, "query")), o.new = function (e, t)
				{
					return new o(e, t)
	...
	}, function (e, t, n)
	{
		...
		e.exports = function (e)
		{
			e.Installation = e.Object.extend("_Installation"), e.Push = e.Push ||
	...
	}, function (e, t, n)
	{
		...
		e.exports = function (e)
		{
			...
			}, e.Query._extend = e._extend, r.extend(e.Query.prototype,
			{
				...
				scan: function ()
				{
					...
					return {
						next: function ()
						{
							...
							{
								return f ? [] : t.length > 1 ? t : h || 0 === t.length ? u("scan/classes", e.className, null, "GET", h ? r.extend(
								{}, c,
								{
									cursor: h
								}) : c, a).then(function (t)
				...
				skip: function (e)
				{
					return f(e, "undefined is not a valid skip value"), this._skip = e, this
				},
				limit: function (e)
				{
					return f(e, "undefined is not a valid limit value"), this._limit = e, this
				},
				equalTo: function (t, n)
				{
					return f(t, "undefined is not a valid key"), f(n, "undefined is not a valid value"), this._where[t] = e._encode(n), this
				},
				_addCondition: function (t, n, r)
				{
					return f(t, "undefined is not a valid condition key"), f(n, "undefined is not a valid condition"), f(r, "undefined is not a valid condition value"), this._where[t] || (this._where[t] = {}), this._where[t][n] = e._encode(r), this
				},
				...
				{
					return f(e, "undefined is not a valid key"), this._order = e, this
				},
				addAscending: function (e)
				{
					return f(e, "undefined is not a valid key"), this._order ? this._order += "," + e : this._order = e, this
				},
				...
				{
					var t = this;
					return f(e, "undefined is not a valid key"), r(arguments).forEach(function (e)
					{
		...
		e.exports = function (e)
		{
			var t = function ()
				{
					...
					{};
					return a(t) ? e.User._fetchUserBySessionToken(a(t)) : e.User.currentAsync()
				},
				n = function (n)
				{
			...
			}, i.extend(e.Status.prototype,
			{
				...
				send: function ()
				{
					...
					return this.query ? n(r).then(function (e)
					{
						...
						var i = {};
						return i.query = n, t.data = t.data ||
						{}, t.data.source = t.data.source || e, i.data = t._getDataJSON(), i.inboxType = t.inboxType || "default", o("statuses", null, null, "POST", i, r)
					}).then(function (n)
					{
			...
			}), e.Status.sendStatusToFollowers = function (t)
			{
				...
				return n(r).then(function (n)
				{
					...
					var s = {};
					return s.query = i, t.data = t.data ||
					{}, t.data.source = t.data.source || n, s.data = t._getDataJSON(), s.inboxType = t.inboxType || "default", o("statuses", null, null, "POST", s, r).then(function (n)
					{
						return t.id = n.objectId, t.createdAt = e._parseDate(n.createdAt), t
					})
				})
			}, e.Status.sendPrivateStatus = function (t, r)
			{
				...
				{};
				if (!a(s) && !e.User.current()) throw new Error("Please signin an user.");
				...
				return n(s).then(function (n)
				{
					...
					var i = {};
					return i.query = r, t.data = t.data ||
					{}, t.data.source = t.data.source || n, i.data = t._getDataJSON(), i.inboxType = "private", t.inboxType = "private", o("statuses", null, null, "POST", i, s).then(function (n)
					{
						return t.id = n.objectId, t.createdAt = e._parseDate(n.createdAt), t
					})
				})
			}, e.Status.countUnreadStatuses = function (n)
			{
				var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "default",
					...
					{};
				if (i.isString(r) || (s = r), !a(s) && null == n && !e.User.current()) throw new Error("Please signin an user or pass the owner objectId.");
	...
	}, function (e, t, n)
	{
		...
		e.exports = function (e)
		{
			e.User = e.Object.extend("_User",
			{
				...
				{
					var t;
					return t = r.isString(e) ? e : e.getAuthType(), !!(this.get("authData") ||
					{})[t]
				},
				logOut: function ()
				{
				...
				{
					var e = this;
					return s("login", null, null, "POST", this.toJSON()).then(function (t)
					{
						var n = e.parse(t);
				...
				{
					var o, s;
					return r.isObject(t) || r.isNull(t) || r.isUndefined(t) ? (o = t, s = n) : (o = {}, o[t] = n, s = i), s = s ||
				...
				unfollow: function (e, t)
				{
					...
					return s(o, null, null, "DELETE", null, t)
				},
			...
			},
			{
				...
				{
					return r = r ||
					{}, r.username = t, r.password = n, e.Object._create("_User").signUp(r, i)
				},
				...
				{
					return r = r ||
					{}, r.mobilePhoneNumber = t, r.smsCode = n, e.Object._create("_User").signUpOrlogInWithMobilePhone(r, i)
				},
				...
				requestMobilePhoneVerify: function (e)
				{
					...
					return t.validateToken && (n.validate_token = t.validateToken), s("requestMobilePhoneVerify", null, null, "POST", n, t)
				},
				requestPasswordResetBySmsCode: function (e)
				{
					...
					return t.validateToken && (n.validate_token = t.validateToken), s("requestPasswordResetBySmsCode", null, null, "POST", n, t)
				},
				resetPasswordBySmsCode: function (e, t)
				{
					return s("resetPasswordBySmsCode", null, e, "PUT",
					{
						password: t
					})
				},
				...
				requestLoginSmsCode: function (e)
				{
					...
					return t.validateToken && (n.validate_token = t.validateToken), s("requestLoginSmsCode", null, null, "POST", n, t)
				},
				currentAsync: function ()
				{
					return e._config.disableCurrentUser ? (console.warn("AV.User.currentAsync() was disabled in multi-user environment, access user from request instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"), u.resolve(null)) : e.User._currentUser ? u.resolve(e.User._currentUser) : e.User._currentUserMatchesDisk ? u.resolve(e.User._currentUser) : e.localStorage.getItemAsync(e._getAVPath(e.User._CURRENT_USER_KEY)).then(function (t)
					{
						...
						var n = JSON.parse(t);
						return e.User._currentUser.id = n._id, delete n._id, e.User._currentUser._sessionToken = n._sessionToken, delete n._sessionToken, e.User._currentUser._finishFetch(n), e.User._currentUser._synchronizeAllAuthData(), e.User._currentUser._refreshCache(), e.User._currentUser._opSetQueue = [
						{}], e.User._currentUser
					})
				},
				current: function ()
				...
				{
					var n;
					return n = e.User._currentUser !== t ? e.User.logOut() : u.resolve(), n.then(function ()
					{
	...
	}, function (e, t, n)
	{
		...
		n(34);
		var r = n(5);
		r._ = n(0), r.version = n(13), r.Promise = n(1), r.localStorage = n(12), r.Cache = n(11), r.Error = n(4), n(29), n(26)(r), n(28)(r), n(22)(r), n(33)(r), n(37)(r), n(27)(r), n(32)(r), n(38)(r), n(41)(r), n(36)(r), n(31)(r), n(23)(r), n(24)(r), n(35)(r), n(40)(r), n(39)(r), n(30)(r), r.Conversation = n(25), e.exports = r
	}, function (e, t, n)
	{
		"use strict";
		e.exports = []
	...
	}, function (e, t, n)
	{
		...
		e.exports = function (e, t, n)
		{
			...
			{
				var u = r("POST", a).set(n._uploadHeaders).field("fileContent", t).field("op", "upload");
	...
	}, function (e, t, n)
	{
		...
		e.exports = function (e, t, n)
		{
			...
			{
				var c = r("POST", u).set(n._uploadHeaders).field("file", t).field("name", n.attributes.name).field("key", n._qiniu_key).field("token", a);
	...
	}, function (e, t, n)
	{
		(function (t)
		{
			...
			}(0, function ()
			{
				...
				function w(e, t)
				{
					e._state === ee && (e._result = t, e._state = te, 0 !== e._subscribers.length && V(A, e))
				}
				...
				function S(e, t, n, r)
				{
					var i = e._subscribers,
						o = i.length;
					e._onerror = null, i[o] = t, i[o + te] = n, i[o + ne] = r, 0 === o && e._state && V(A, e)
				}
				...
				function j(e, t, n, i)
				{
					...
					if (o)
					{
						if (s = T(n, i), s === ie ? (c = !0, a = s.error, s.error = null) : u = !0, t === s) return void O(t, d())
					}
					else s = i, u = !0;
				...
				function q(e)
				{
					this[Z] = C(), this._result = this._state = void 0, this._subscribers = [], h !== e && ("function" != typeof e && D(), this instanceof q ? N(this, e) : L())
				}
				...
				var B = F,
					...
					G = "undefined" == typeof self && "undefined" != typeof process && "[object process]" ===
				...
				}, q.all = I, q.race = P, q.resolve = l, q.reject = R, q._setScheduler = i, q._setAsap = o, q._asap = V, q.prototype = {
					constructor: q,
					then: c,
					catch: function (e)
					{
